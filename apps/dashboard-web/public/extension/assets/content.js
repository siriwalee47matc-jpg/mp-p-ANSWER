const m=["ลด 10 กิโลใน 3 วัน","ลด 10 กิโล ภายใน 3 วัน","คุมหิว ลดน้ำหนักสูตรเร่งด่วน","รักษาโรคมะเร็งหายขาด","มะเร็งหายขาดใน 1 เดือน","รักษามะเร็งหายขาด","สูตรรักษาโรคมะเร็ง","ขาวใสภายใน 2 วัน","ขาวใสเร่งด่วนใน 2 วัน","ยาเทวดารักษาได้ทุกโรค","cure cancer","weight loss fast","100% safe","doctor recommended"],x=[{productType:"DRUG",keywords:["drug","medicine","capsule","tablet","antibiotic","ยา"]},{productType:"COSMETIC",keywords:["cosmetic","serum","cream","whitening","beauty","skincare","ครีม"]},{productType:"MEDICAL_DEVICE",keywords:["medical device","test kit","monitor","mask","เครื่องมือแพทย์"]},{productType:"CLINIC",keywords:["clinic","hospital","doctor","treatment center","คลินิก","แพทย์"]},{productType:"HERBAL",keywords:["herbal","botanical","traditional herb","สมุนไพร"]},{productType:"FOOD",keywords:["food","supplement","dietary","beverage","coffee","tea","อาหาร"]}];let p=!1,c=!1;function f(){chrome.storage.local.get(["extensionMode","autoScan","riskLevel"],o=>{const e=o.autoScan!==!1&&o.riskLevel!=="MANUAL";if(o.extensionMode!=="CONSUMER"||!e)return;const t=document.body.innerText||"",i=m.filter(n=>t.toLowerCase().includes(n.toLowerCase()));i.length>0&&!p&&!c&&y(i)})}function g(){const o=window.location.hostname.replace("www.","").toLowerCase();chrome.runtime.sendMessage({action:"CHECK_DOMAIN",domain:o},e=>{e&&e.isBlocked?u("โดเมนนี้ถูกขึ้นบัญชีเฝ้าระวังและบล็อกการเข้าถึงจากศูนย์ควบคุมโฆษณาผิดกฎหมาย"):setTimeout(f,1e3)})}function y(o){p=!0;const e=document.createElement("div");e.id="kp-ad-shield-banner",e.style.cssText=`
    position: fixed;
    top: 0;
    left: 0;
    width: 100%;
